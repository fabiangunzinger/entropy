...
between \pounds1000 and \pounds2000.\footnote{{\color{blue} Note that the effect of an additional \pounds1000 of income is 0.012, while the effect of a one standard-deviation increase in unsmoothed entropy is between 0.011 and 0.023, depending on the definition of entropy}} Combined, the results in the three columns

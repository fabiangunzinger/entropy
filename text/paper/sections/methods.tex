...
\input{\tabdir/sumstats.tex} \tabnote{\textwidth}{Income and spend variables in
...
\begin{figure}[h]
    ...
    \includegraphics[width=.49\textwidth]{\figdir/year_income.png}
    \includegraphics[width=.49\textwidth]{\figdir/year_spend.png}
    \includegraphics[width=.49\textwidth]{\figdir/age.png}
    \includegraphics[width=.49\textwidth]{\figdir/region.png}

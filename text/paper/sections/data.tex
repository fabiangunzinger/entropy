...
of a users's savings accounts. The large number of zero net flows represent
months where inflows are perfectly balanced by outflows (not months where there
were no flows, which are not show).}
